...
struct RestaurantPostResponse: Mappable, Codable {
    ...
    mutating func mapping(map: Map) {
        restaurantPostList <- map["RestaurantPostList"]
    }
}

struct RestaurantPostList: Mappable, Codable {
